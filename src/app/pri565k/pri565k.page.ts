...
@Component({
  selector: 'app-pri565k',
  templateUrl: './pri565k.page.html',
  styleUrls: ['./pri565k.page.scss'],
})
export class Pri565kPage implements OnInit {
      loading:any
      sub:Subscription
      page=1;
      limit=5
  ...
  //event?เป็น optional
  getPri565k(event?:any){
    //get news again
  this.sub = this.ds.getPri565k(this.page,this.limit).subscribe((res:any)=>{
    ...
    this.Results=this.Results.concat(res.data.pri565k);
