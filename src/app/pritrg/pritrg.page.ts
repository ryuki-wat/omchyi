...
@Component({
  selector: 'app-pritrg',
  templateUrl: './pritrg.page.html',
  styleUrls: ['./pritrg.page.scss'],
})
export class PritrgPage implements OnInit {
  loading:any
  sub:Subscription
  page=1;
  limit=5
  ...
  getPriTrg(event?:any){
    //get news again
  this.sub = this.ds.getPriTrg(this.page,this.limit).subscribe((res:any)=>{
    ...
    this.Results=this.Results.concat(res.data.pritrg);
