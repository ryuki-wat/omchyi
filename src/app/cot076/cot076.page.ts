...
@Component({
  selector: 'app-cot076',
  templateUrl: './cot076.page.html',
  styleUrls: ['./cot076.page.scss'],
})
export class Cot076Page implements OnInit {
  loading:any
  sub:Subscription
  page=1;
  limit=5
  ...
  constructor(
    ...
    getCot076(event?:any){
      //get news again
    this.sub = this.ds.getCot076(this.page,this.limit).subscribe((res:any)=>{
      ...
      this.Results=this.Results.concat(res.data.cot076);
