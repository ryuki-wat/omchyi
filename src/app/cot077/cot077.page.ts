...
@Component({
  selector: 'app-cot077',
  templateUrl: './cot077.page.html',
  styleUrls: ['./cot077.page.scss'],
})
export class Cot077Page implements OnInit {
  loading:any
  sub:Subscription
  page=1;
  limit=5
  ...
  getCot077(event?:any){
    //get news again
  this.sub = this.ds.getCot077(this.page,this.limit).subscribe((res:any)=>{
    ...
    this.Results=this.Results.concat(res.data.cot077);
