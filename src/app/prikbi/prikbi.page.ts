...
@Component({
  selector: 'app-prikbi',
  templateUrl: './prikbi.page.html',
  styleUrls: ['./prikbi.page.scss'],
})
export class PrikbiPage implements OnInit {
  loading:any
  sub:Subscription
  page=1;
  limit=5
  ...
  getPriKbi(event?:any){
    //get news again
  this.sub = this.ds.getPriKbi(this.page,this.limit).subscribe((res:any)=>{
    ...
    this.Results=this.Results.concat(res.data.prikbi);
