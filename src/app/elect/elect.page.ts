...
@Component({
  selector: 'app-elect',
  templateUrl: './elect.page.html',
  styleUrls: ['./elect.page.scss'],
})
export class ElectPage implements OnInit {
  loading:any
  sub:Subscription
  page=1;
  limit=5
  ...
  getElect(event?:any){
    //get news again
  this.sub = this.ds.getElect(this.page,this.limit).subscribe((res:any)=>{
    ...
    this.Results=this.Results.concat(res.data.elect);
